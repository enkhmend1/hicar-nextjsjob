    ...
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <header className="md:hidden sticky top-0 z-30 bg-white border-b border-gray-200 px-3 h-14 flex items-center justify-between">
          <Link href="/seller" className="text-[16px] font-semibold pl-1">
            <em className="text-blue-600 not-italic">Hi</em>car <span className="ml-1 text-[10px] bg-amber-100 text-amber-700 px-1.5 py-0.5 rounded font-semibold align-middle">SELLER</span>
          </Link>
            ...
            <div className="absolute inset-y-0 left-0 w-72 max-w-[85vw] bg-white shadow-2xl flex flex-col animate-in slide-in-from-left duration-200">
              <div className="px-4 h-14 flex items-center justify-between border-b border-gray-100 shrink-0">
                <span className="text-[16px] font-semibold">
                  <em className="text-blue-600 not-italic">Hi</em>car <span className="text-[10px] text-amber-600 font-semibold">SELLER</span>
                </span>
              ...
              <div className="p-3 border-t border-gray-100 shrink-0">
                ...
                <div className="px-3 pt-3 mt-2 border-t border-gray-100">
                  <div className="text-[13px] font-semibold text-gray-800 truncate">{user.sellerProfile?.shopName || user.name}</div>
