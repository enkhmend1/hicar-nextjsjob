  ...
  return (
    <div ref={ref} className="relative">
      <button onClick={() => setOpen(o => !o)}
        className={`flex items-center gap-1.5 border border-gray-200 rounded-lg ${compact ? "px-2 py-1.5" : "px-3 py-1.5"} text-[13px] text-gray-600 hover:border-blue-500 hover:text-blue-600 transition-colors cursor-pointer bg-white font-sans`}>
