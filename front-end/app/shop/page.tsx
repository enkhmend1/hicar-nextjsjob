        ...
        <div className="flex flex-col sm:flex-row gap-3 mb-5">
          <div className="relative flex-1">
            ...
            <input value={q} onChange={e => setQ(e.target.value)}
              className="w-full bg-white border border-gray-200 rounded-xl pl-9 pr-4 py-2.5 text-[14px] focus:border-blue-500 shadow-sm"
              placeholder="Сэлбэг хайх... (нэр, OEM, брэнд)" />
          </div>
          <div className="flex gap-2">
            <select value={srcFilter} onChange={e => setSrcFilter(e.target.value)}
              className="bg-white border border-gray-200 rounded-xl px-3 py-2.5 text-[13px] text-gray-600 cursor-pointer focus:border-blue-500 font-sans shadow-sm">
